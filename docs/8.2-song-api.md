...
The Song API provides endpoints for managing a music library in ZiOS, including CRUD operations for songs, lyrics fetching from KuGou, AI-powered translations, Japanese furigana annotations, and "soramimi" (空耳) phonetic readings.
...
The admin user is `zi` (case-insensitive).
