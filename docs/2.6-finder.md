...
### Getting Started
To launch the Finder app, simply click its icon in the ZiOS Dock or locate it within the Applications folder. Upon opening, Finder will typically display your home directory, allowing you to immediately begin browsing and managing your files.
...
*   **Managing Items:**
    ...
    *   **Delete:** Drag files or folders to the `Trash` icon in the Finder window's footer or the ZiOS Dock to send them to the trash.
...
### Tips & Shortcuts
*   **Drag & Drop Efficiency:** Finder fully supports drag-and-drop functionality for moving, copying (if applicable), and deleting files, as well as interacting with other ZiOS applications.
...
Finder integrates seamlessly with other ZiOS applications; for instance, files can be opened by their respective default applications (e.g., a text file by [TextEdit](/docs/textedit)), and newly installed applications from the [Applet Store](/docs/applet-store) automatically appear in the Applications folder.
