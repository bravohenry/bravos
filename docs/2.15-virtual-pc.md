...
*   **PC Emulator**: Run a wide array of classic DOS games and applications directly within your ZiOS browser environment, powered by js-dos.
...
*   **Mouse Capture**: Seamlessly switch between controlling the ZiOS desktop and the emulated PC by clicking inside the Virtual PC window to capture the mouse, and clicking again or pressing `Esc` to release it.
...
### Getting Started
To launch Virtual PC, simply click its icon in the ZiOS application launcher. Once open, the app will load a default game or DOS environment, ready for interaction. Use your keyboard and mouse to navigate and play.
...
*   **Interacting with the Emulator**:
    ...
    *   **Mouse Control**: Click anywhere inside the Virtual PC window to capture your mouse cursor, allowing you to use it within the emulated environment. To release the mouse and regain control of the ZiOS desktop, click again or press the `Escape` key.
...
*   **Performance**: For the best experience, ensure your browser and system meet the recommended ZiOS specifications. Closing other demanding applications might improve emulator performance.
...
Global state management is handled by Zustand stores, specifically `usePcStore` for managing the list of available games and `useThemeStore` for integrating with ZiOS theme settings.
