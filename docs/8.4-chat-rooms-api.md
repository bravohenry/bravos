...
| POST     | `generateRyoReply`         | Generate AI reply from Zi               | Yes           |
...
Headers: { X-Username: "zi", Authorization: "Bearer <token>" }
...
### AI-Powered Replies (Zi)

Generate responses from the AI assistant "Zi":
...
- [ZiOS Overview](/docs/overview) - Main documentation
