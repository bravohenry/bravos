...
The OS1 branch extends the base ZiOS project with a comprehensive macOS-inspired theme that brings authentic macOS system sounds, SF Symbols integration, and refined UI/UX enhancements.

## Overview

OS1 is a modern macOS-inspired theme built on top of ZiOS, featuring:
...
This branch maintains the same license as the base ZiOS project (AGPL-3.0).
